...
- **6.7. Коды ошибок** — Таблица HTTP статусов и их значений
- **6.8. Pydantic схемы** — Полные описания request/response моделей
...
- **10.10. Статус реализации фронтенда**
  ...
  - **10.10.2. Реализованный функционал** — Auth, список чатов, отправка сообщений, WebSocket
  - **10.10.3. Нереализованный функционал** — Поиск, удаление, управление участниками, файлы, админка
